...
check(var_Nome,var_Valore,var_Saldo,var_Buyer):- \+dif(var_Nome,null),\+dif(var_Valore,null),write('Non posso venderti nulla, mi spiace!').

check(var_Nome,var_Valore,var_Saldo,var_Buyer):-var_Valore>var_Saldo,write('Non hai abbastanza soldi per i miei prodotti!').

check(var_Nome,var_Valore,var_Saldo,var_Buyer):-var_Valore=<var_Saldo,invia_oggetto([var_Nome,var_Valore],var_Buyer),invia_lista_oggetti(var_AltriOggetti,var_Buyer,var_Saldo).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_379235,var_Ontology,_379239),_379229),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_379273)),a(message(var_Ag,propose(var_A,[_379273],var_AgI))),retractall(ext_agent(var_Ag,_379311,var_Ontology,_379315)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_379109,var_Ontology,_379113),_379103),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_379179,var_Ontology,_379183)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_378997,var_Ontology,_379001),_378991),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_379053,var_Ontology,_379057)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_378561),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_378595),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_378377).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_378225),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_378173),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_378049,_378051)),clause(agente(_378071,_378073,_378075,var_S),_378067),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_377843,_377845,_377847,var_S),_377839),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_377943,[]),repeat,read(_377943,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_377943).
